...
```
From this we can interpret that there is a causal relation between attitude and exam points. However, the R-Squared is still low (0.19). In the next section we can examine the model with diagnostics plots.
